...
import {
  ...
  ChevronLeft, Menu, LogOut, ExternalLink, Bell, Search,
} from "lucide-react";
...
export default function OwnerSidebar() {
  ...
  return (
    <aside
      className={`h-screen sticky top-0 flex flex-col bg-[#0a0a0a] border-r border-white/10 transition-all duration-300 flex-shrink-0 ${
        collapsed ? "w-16" : "w-60"
      }`}
    >
      {/* Logo */}
